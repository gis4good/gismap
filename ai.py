...
def app():
    ...
    if st.button('Process'):  
       ...
       lat=data[0]
       long=data[1] 
       vv=requests.get(f'https://db27e12267fe25d8f3740594f8d94853.serveo.net/ai/?x1={long}&y1={lat}') 
       ...
       st.components.v1.html(vv.text.replace(f'<img src="/static/images/{pp}"',f'<img src="https://db27e12267fe25d8f3740594f8d94853.serveo.net/static/images/{pp}"').replace(f'<img src="/static/images/{pp1}"',f'<img src="https://db27e12267fe25d8f3740594f8d94853.serveo.net/static/images/{pp1}"'),height=800)
       gif_runner.empty()
