...
def app():
    ...
    if st.button('Process'):  
       ...
       lat=data[0]
       long=data[1] 
       vv=requests.get(f'http://praecox.serveo.net/ai/?x1={long}&y1={lat}') 
       ...
       st.components.v1.html(vv.text.replace(f'<img src="/static/images/{pp}"',f'<img src="http://praecox.serveo.net/static/images/{pp}"'),height=400)
       gif_runner.empty()
