...
def app():
    ...
    if st.button('Process'):  
       ...
       lat=data[0]
       long=data[1] 
       vv=requests.get(f'https://esse.serveo.net/ai/?x1={long}&y1={lat}') 
       ...
       st.components.v1.html(vv.text.replace(f'<img src="/static/images/{pp}"',f'<img src="https://esse.serveo.net/static/images/{pp}"'),height=400)
       gif_runner.empty()
