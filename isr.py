            ...
            if len(pwp)>1:
               try: 
                   ...
                   nae=pd.DataFrame({'State':pwp['State'],'District':pwp['District'],'Pincode':pwp['Pincode'],
                                     ...
                                     '1-30DelBal':(pwp['1+ Delinquency Balance.1']-pwp['30+ Delinquency Balance.1'])+(pwp['1+ Delinquency Balance.4']-pwp['30+ Delinquency Balance.4']),'30-179DelBal':pwp['30+ Delinquency Balance.1']+pwp['30+ Delinquency Balance.4'],'30-60DelBal':(pwp['30+ Delinquency Balance.1']-pwp['60+ Delinquency Balance.1'])+(pwp['30+ Delinquency Balance.4']-pwp['60+ Delinquency Balance.4']),'60-179DelBal':pwp['60+ Delinquency Balance.1']+pwp['60+ Delinquency Balance.4'],'180+DelBal':pwp['180+ Delinquency Balance.1_y']+pwp['180+ Delinquency Balance.4_y'],'1-179DelBal':pwp['1+ Delinquency Balance.1']+pwp['1+ Delinquency Balance.4'],'1-179DPD%':(single1.div(single2.where(single2!= 0,0)))*100
