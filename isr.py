            ...
            if len(pwp)>1:
               try: 
                   ...
                   nae=pd.DataFrame({'State':pwp['State'],'District':pwp['District'],'Pincode':pwp['Pincode'],
                                     ...
                                     '1-30DelBal':(pwp['1+ Delinquency Balance.1']+pwp['1+ Delinquency Balance.4'])-(pwp['30+ Delinquency Balance.1']+pwp['30+ Delinquency Balance.4']),'30-179DelBal':pwp['30+ Delinquency Balance.1']+pwp['30+ Delinquency Balance.4'],'30-60DelBal':(pwp['30+ Delinquency Balance.1']+pwp['30+ Delinquency Balance.4'])-(pwp['60+ Delinquency Balance.1']+pwp['60+ Delinquency Balance.4']),'60-179DelBal':pwp['60+ Delinquency Balance.1']+pwp['60+ Delinquency Balance.4'],'180+DelBal':pwp['180+ Delinquency Balance.1_y']+pwp['180+ Delinquency Balance.4_y'],'1-179DelBal':pwp['1+ Delinquency Balance.1']+pwp['1+ Delinquency Balance.4'],'1-179DPD%':(single1.div(single2.where(single2!= 0,0)))*100
                                     }).fillna(0).replace([np.inf, -np.inf], 0)
                    
                   pp=['1-179DPD%']
                   nae[pp]=np.where(nae[pp]>100,100,nae[pp])
                   
                   total1=pwp['1+ Delinquency Balance.1']+pwp['1+ Delinquency Balance.4']
                   ...
                   nae1=pd.DataFrame({'State':pwp['State'],'District':pwp['District'],'Pincode':pwp['Pincode'],
                                     ...
                                     '1-30DelBal':pwp['1+ Delinquency Balance.5']-pwp['30+ Delinquency Balance.5'],'30-179DelBal':pwp['30+ Delinquency Balance.5'],'30-60DelBal':pwp['30+ Delinquency Balance.5']-pwp['60+ Delinquency Balance.5'],'60-179DelBal':pwp['60+ Delinquency Balance.5'],'180+DelBal':pwp['180+ Delinquency Balance.5_y'],'1-179DelBal':pwp['1+ Delinquency Balance.5'],'1-179DPD%':(total1.div(total2.where(total2!= 0,0)))*100
                                     }).fillna(0).replace([np.inf, -np.inf], 0)
