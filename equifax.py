            ...
            if len(cwp)>1:
               try: 
                   ...
                   nae=pd.DataFrame({'State':pwp['State'],'District':pwp['District'],'Pincode':pwp['Pincode'],
                                    ...
                                    'p1_t':pwp['Average Ticket Size'],'p2_t':pwp['Average Ticket Size.1'],'p3_t':pwp['Average Ticket Size.2'],'p4_t':pwp['Average Ticket Size.3'],'p5_t':pwp['Average Ticket Size.4'],
                                    'p1_d':pwp['No. of Loans'],'p2_d':pwp['No. of Loans.1'],'p3_d':pwp['No. of Loans.2'],'p4_d':pwp['No. of Loans.3'],'p5_d':pwp['No. of Loans.4'],
